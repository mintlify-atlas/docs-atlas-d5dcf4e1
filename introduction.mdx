...
description: "InventarioITU manages computer lab equipment at ITU Mendoza using a dual-database architecture, LDAP authentication, and containerized Kubernetes deployment."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Core Features" icon="list-check" href="/introduction#core-features">
...
| **SQL Server** | Stores structured location, room, lab, and equipment assignment records in the `ubicacion-db` service |
