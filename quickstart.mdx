---
title: "InventarioITU Quickstart: Local Deployment with Minikube"
sidebarTitle: "Quickstart"
description: "Stand up the full InventarioITU stack locally using Docker and Minikube in under 30 minutes, with step-by-step instructions for every service."
---
...
<Steps>
  ...
  <Step title="Access the web application">
    ...
    Minikube will print a URL such as `http://192.168.49.2:30080`. Open that address in your browser to reach the InventarioITU login page. You will need valid LDAP credentials to log in — see the [LDAP Configuration](/operations/ldap-configuration) guide for how to seed the directory with initial user accounts.
  </Step>
</Steps>
